    ...
    public partial class firstMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "faculties",
                columns: new[] { "id", "name" },
                values: new object[] { 1, "Программирования" });

            migrationBuilder.InsertData(
                table: "faculties",
                columns: new[] { "id", "name" },
                values: new object[] { 2, "Администрирования" });

            migrationBuilder.InsertData(
                table: "faculties",
                columns: new[] { "id", "name" },
                values: new object[] { 3, "Графики" });

            migrationBuilder.InsertData(
                table: "groups",
                columns: new[] { "id", "facultyId", "name" },
                values: new object[] { 1, 1, "СПВ22-01" });

            migrationBuilder.InsertData(
                table: "groups",
                columns: new[] { "id", "facultyId", "name" },
                values: new object[] { 3, 1, "СПУ20-01" });

            migrationBuilder.InsertData(
                table: "groups",
                columns: new[] { "id", "facultyId", "name" },
                values: new object[] { 2, 3, "СПД22-21" });
